...
namespace Glitch9.CoreLib.IO.Audio
{
    ...
    public class RealtimeAudioRecorder
    {
        ...
        public void StartRecording()
        {
            ...
            Microphone.Start(_microphoneDevice, true, 600, sampleRateAsInt);
#else
            AudioClip clip = Microphone.Start(_microphoneDevice, true, 600, sampleRateAsInt); // Record for up to 10 minutes
        ...
        public void SetMicrophoneDevice(string device)
        {
            ...
            _logger.Info("Microphone device set to: " + device);
        }
